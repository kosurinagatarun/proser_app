...
class HomeScreenPlots extends StatefulWidget {
  @override
  _HomeScreenPlotsState createState() => _HomeScreenPlotsState();
}

class _HomeScreenPlotsState extends State<HomeScreenPlots> {
  ...
  Widget _buildPremiumBannerType1() {
    List<Map<String, String>> premiumDeals = [
      {
        "image": "assets/images/plot1.jpg",
        "title": "Cosmopolis",
        "builder": "By Richland Infra Developers",
      ...
      {
        "image": "assets/images/plot2.jpg",
        "title": "Eastern Meadows",
        "builder": "By Akshita Infra",
      ...
      {
        "image": "assets/images/plot3.jpg",
        "title": "Aero Gate",
        "builder": "By Dharani Infra Developers",
  ...
  Widget _buildPremiumBannerType2() {
    List<Map<String, String>> editorChoices = [
      {
        "image": "assets/images/plot4.jpg",
        "title": "Rainbow County",
        "builder": "By Bhashyam Developers",
        "availability": "Ready By Sep 2025",
        "location": "Tellapur",
      ...
      {
        "image": "assets/images/plot5.jpg",
        "title": "Sarovar",
        "builder": "By TMR Group",
        "availability": "Possession in 2024",
        "location": "Hitech City",
        "propertyType": "2, 3 BHK Plots",
        "priceRange": "₹ 1.2 Cr - ₹ 3.00 Cr",
        "profile": "assets/images/builder_logo.png",
      },
      {
        "image": "assets/images/plot6.jpg",
        "title": "Green Swing",
        "builder": "By Avani Projects & Developers",
        "availability": "Ongoing Project",
        "location": "Gachibowli",
        "propertyType": "3, 4 BHK Villas",
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    transitionDuration: Duration(milliseconds: 400),
                    pageBuilder: (_, __, ___) => SearchScreen(onLocationSelected: (String location) {  },),
                    transitionsBuilder: (_, animation, __, child) {
                      const begin = Offset(1.0, 0.0);
                      const end = Offset.zero;
                      const curve = Curves.easeInOut;
  ...
  Widget _buildCategorySectionType1() {
    List<Map<String, String>> categories = [
      {"title": "FarmLands", "icon": "assets/icons/home.png"},
      {"title": "Villa Plots", "icon": "assets/icons/home.png"},
      {"title": "Residential open plots", "icon": "assets/icons/home.png"},
      {"title": "Gated community Plots", "icon": "assets/icons/home.png"},
      {"title": "Plots with offers", "icon": "assets/icons/home.png"},
    ];
...
//           {"name": "Serviced Plots", "image": "assets/images/house1.png"},
...
Widget _buildPremiumBannerItem4(
    BuildContext context, Map<String, String> property) {
  double cardHeight = MediaQuery.of(context).size.width * 0.6;
...
Widget _buildPremiumBannerType5() {
  List<Map<String, dynamic>> builderFocus = [
    {
      "builderName": "Vamsi Krishna",
      "profile": "assets/images/builder_logo.png",
      "verified": true,
      "projects": "46 Project",
      "properties": [
        {
          ...
          "location": "Kompally",
          "propertyType": "3, 4 & 5 BHK",
          "priceRange": "₹ 96.0L - ₹ 2.50Cr",
        ...
        },
        {
          ...
          "location": "Gachibowli",
          "propertyType": "3, 4 BHK",
          "priceRange": "₹ 1.50Cr - ₹ 3.80Cr",
          "brandLogo": "assets/images/elite_logo.jpg"
        },
      ]
    },
    {
      "builderName": "Raghav Developers",
      "profile": "assets/images/builder_logo.png",
      "verified": true,
      "projects": "38 Project",
      "properties": [
        ...
        },
        {
          ...
          "title": "Sarovar",
          "builder": "By TMR Group",
          "availability": "Ready by 2026",
          "location": "Gachibowli",
          "propertyType": "2, 3 BHK",
          "priceRange": "₹ 1.00Cr - ₹ 2.50Cr",
          "brandLogo": "assets/images/elite_logo.jpg"
        },
        {
          "image": "assets/images/plot9.jpg",
        ...
        children: [
          ...
          Container(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildBuilderFocusCard(builderFocus[index]);
              },
            ),
          ),
          SizedBox(height: 10),
          Center(
            child: DotsIndicator(
              dotsCount: builderFocus.length,
              position: _currentBuilderIndex.toDouble(),
              decorator: DotsDecorator(
                activeColor: primaryGreen,
                size: const Size.square(8.0),
                activeSize: const Size(16.0, 8.0),
...
Widget _buildBuilderFocusCard(Map<String, dynamic> builder) {
  return Container(
    margin: EdgeInsets.symmetric(horizontal: 5),
    decoration: BoxDecoration(
      color: Color(0xFFF5E3D3),
      border: Border.all(
    ...
    child: Column(
      children: [
        // White section for builder info without border
        Container(
        ...
        // Properties as horizontal cards (240 width)
        Container(
          height: 410,
          padding: EdgeInsets.only(left: 12),
          child: ListView.builder(
            scrollDirection: Axis.horizontal,
            itemCount: builder["properties"].length,
            itemBuilder: (context, index) {
              return Container(
                width: 260,
                margin: EdgeInsets.only(right: 5),
                child: _buildPropertyCard(builder["properties"][index]),
              );
            },
          ),
        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            property["builder"]!,
                            style: TextStyle(
                                fontSize: smallFont, color: Colors.grey),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                          ),
                          Text(
                          ...
                          Row(
                            children: [
                              Icon(Icons.location_on,
                                  color: primaryGreen, size: smallFont + 1),
                              SizedBox(width: 4),
                              Expanded(
                                child: Text(
                                  property["location"]!,
...
Widget _buildLocalityBanner(
  ...
  //     context,
  //     MaterialPageRoute(
  //       builder: (context) => HotLocalitiesPage(slug: locality.slug),
  //     ),
  //   );
  // },
                child: Text(
...
Widget _buildPremiumBannerType11(BuildContext context) {
  List<Map<String, String>> propertyNews = [
    {
      "image": "assets/images/plot1.jpg",
      "title": "Popular areas to rent Plots and villas in Hyderabad city",
